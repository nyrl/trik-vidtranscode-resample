#ifndef TRIK_VIDEO_RESAMPLE_INTERNAL_VIDTRANSCODE_RESAMPLE_IFACE_H_
#define TRIK_VIDEO_RESAMPLE_INTERNAL_VIDTRANSCODE_RESAMPLE_IFACE_H_
...
#endif // !TRIK_VIDEO_RESAMPLE_INTERNAL_VIDTRANSCODE_RESAMPLE_IFACE_H_
